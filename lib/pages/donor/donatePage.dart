...
class FormSample extends StatefulWidget {
  ...
  final List<String> orgAddresses;
...
class _FormSampleState extends State<FormSample> {
  ...
  // List<String> userAddresses = ["1", "2"];
  final FirebaseUserAPI _userAPI = FirebaseUserAPI(); // Add this line
  ...
  int donationId = 0;
  late StreamSubscription<List<AppUser>> _userSubscription;
  ...
  int generateUniqueId() {
    ...
    final random = Random().nextInt(900) +
  ...
  void resetFields() {
    setState(() {
      ...
      addresses = widget.userAddresses.isNotEmpty ? widget.userAddresses[0] : '';
      contact = "";
      status = "Pending";
    });
  ...
  Widget build(BuildContext context) {
    ...
    // Stream<List<AppUser>> userStream = context.watch<UserProvider>().donorStream;
    // AppUser user = context.read<UserProvider>.getAccountInfo(getUserId());
    // setState(() {
            ...
            children: [
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 8),
                                  Text(
                                    'Addresses: ${widget.userAddresses}',
                                    style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
              ...
              //   ),
                ...
                Address(
                  ...
                  onChanged: (String? newAddress) {
                    // Handle the new address selection here
                    print('Selected Address: $newAddress');
                    setState(() {
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed:
                      (dateTime.isBefore(DateTime.now()) || categories.isEmpty)
                          ? null
                          : () async {
